...
INSERT INTO lunch (ID, LUNCH_DATE, RESTAURANT_ID, NAME, PRICE) VALUES (0, today(), 0, 'Макчикен', 100), (1, '2018-05-23', 0, 'Картофель фри', 75), (2, today(), 1, 'Двойной Чизбургер', 118), (3, '2018-05-23', 1, 'Цезарь Ролл', 164), (4, today(), 2, 'Танкобургер', 120), (5, '2018-05-23', 2, 'Чиззи Чикен Фри', 80);
